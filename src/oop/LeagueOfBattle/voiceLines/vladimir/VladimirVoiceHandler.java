package oop.LeagueOfBattle.voiceLines.vladimir;
...
public class VladimirVoiceHandler implements ChampionVoiceLineHandler {
    ...
    public VladimirVoiceHandler(SoundHandler soundHandler) {
